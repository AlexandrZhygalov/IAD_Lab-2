...
def best_model_search(X, Y, dataset_name):
...
def alt_models(X_moons, X_blobs):
    ...
    end_time = time.time()
    print(f"moons_1 - Час кластеризації: {end_time - start_time:.4f} секунд")
    start_time = time.time()
    label_moon_2 = model_moons_2.fit_predict(X_moons)
    end_time = time.time()
    print(f"moons_2 - Час кластеризації: {end_time - start_time:.4f} секунд")
    start_time = time.time()
    label_moon_3 = model_moons_3.fit_predict(X_moons)
    end_time = time.time()
    print(f"moons_3 - Час кластеризації: {end_time - start_time:.4f} секунд")
    start_time = time.time()
    label_blobs_1 = model_blobs_1.fit_predict(X_blobs)
    end_time = time.time()
    print(f"blobs_1 - Час кластеризації: {end_time - start_time:.4f} секунд")
    start_time = time.time()
    label_blobs_2 = model_blobs_2.fit_predict(X_blobs)
    end_time = time.time()
    print(f"blobs_2 - Час кластеризації: {end_time - start_time:.4f} секунд")
    start_time = time.time()
    label_blobs_3 = model_blobs_3.fit_predict(X_blobs)
    end_time = time.time()
    print(f"blobs_3 - Час кластеризації: {end_time - start_time:.4f} секунд")
